...
xterm -T "Vehicle Sim" -geometry "90x30+0+0" -e "sim_vehicle.py -N -v ArduCopter --console --map --out=udp:127.0.0.1:14550 --out=udp:127.0.0.1:14551 --add-param-file=/tmp/mavproxy_params.txt > /tmp/sim_vehicle.log 2>&1"